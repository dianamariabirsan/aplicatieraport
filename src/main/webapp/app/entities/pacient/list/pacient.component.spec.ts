...
import { sampleWithRequiredData } from '../pacient.test-samples';
...
describe('Pacient Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.pacients()[0]).toEqual(expect.objectContaining({ id: 14998 }));
  });

  describe('trackId', () => {
    it('should forward to pacientService', () => {
      const entity = { id: 14998 };
      jest.spyOn(service, 'getPacientIdentifier');
      const id = comp.trackId(entity);
      expect(service.getPacientIdentifier).toHaveBeenCalledWith(entity);
