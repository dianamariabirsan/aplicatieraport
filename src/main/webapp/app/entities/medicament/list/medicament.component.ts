...
export class MedicamentComponent implements OnInit {
  ...
  medicaments = signal<IMedicament[]>([]);
  isLoading = false;
  ...
  protected readonly medicamentService = inject(MedicamentService);
  protected readonly activatedRoute = inject(ActivatedRoute);
  protected readonly sortService = inject(SortService);
  protected modalService = inject(NgbModal);
  protected ngZone = inject(NgZone);

  trackId = (item: IMedicament): number => this.medicamentService.getMedicamentIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.medicaments.set(dataFromBody);
  }
