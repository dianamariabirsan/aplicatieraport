...
export class DecisionLogComponent implements OnInit {
  ...
  decisionLogs = signal<IDecisionLog[]>([]);
  isLoading = false;
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.decisionLogs.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: IDecisionLog[] | null): IDecisionLog[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.decisionLogService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
