...
import com.example.healthapp.config.Constants;
import com.example.healthapp.domain.User;
import com.example.healthapp.repository.AuthorityRepository;
...
import com.example.healthapp.service.dto.PasswordChangeDTO;
import com.example.healthapp.web.rest.vm.KeyAndPasswordVM;
import com.example.healthapp.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testRegisterDuplicateEmail() throws Exception {
        ...
        // Case-insensitive duplicate email is also rejected
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.orElseThrow().getAuthorities())
            .hasSize(2)
            .doesNotContain(authorityRepository.findById(AuthoritiesConstants.ADMIN).orElseThrow())
            .contains(
                authorityRepository.findById(AuthoritiesConstants.USER).orElseThrow(),
                authorityRepository.findById(AuthoritiesConstants.PACIENT).orElseThrow()
            );
